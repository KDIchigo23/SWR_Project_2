            ...
            <div class="container-fluid bg-gradient p-5">
                        ...
                        <div class="card">
                            <article class="filter-group">
                                <header class="card-header">
                                    <h6 class="title">
                                        <a class="list-group-item list-group-item-action" href="DispatchServlet?btAction=CreateForm">Add a new product</a>
                                    </h6>
                                </header>
                            </article>
                            <article class="filter-group">
                ...
                <div class="col-md-9">
                    <div class="row">
                        ...
                        <c:forEach items="${listProduct}" var="b">
                            <div class="col-md-4" id="form-update">
                                <form action="UpdateServlet?id=${b.getProductId()}&i=${index}" method="post" enctype="multipart/form-data">
                                    <div class="pricing-divider">
                                        <h4>${b.getProductId()}</h4>
                                    ...
                                    <div class="card-body bg-white mt-0 shadow" id="form-update">
                                        <input type="text" name="name" value="${b.getProductName()}"/>
                                        <ul class="list-unstyled mb-5 position-relative">
                                            <li><b>Price</b><input type="text" name="price" value="${b.getPrice()}"/></li>
                                            <li><b>Unit </b><input type="text" name="unit" value="${b.getUnit()}"/></li>
                                        ...
                                        <button><a href="DispatchServlet?btAction=Delete&id=${b.getProductId()}"
