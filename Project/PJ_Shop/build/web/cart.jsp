                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${cart}" var="i">
                                        <c:set scope="session" var="totalOrder" value="${totalOrder + i.getProduct().getPrice() * i.getQuantity()}"/>
                                        <tr>
                                            <td>
                                                <div class="display-flex align-center">
                                                    <div class="img-product">
                                                        <img src="photo/${i.getProduct().getImg()}" alt="" class="mCS_img_loaded">
                                                    </div>
                                                    <div class="name-product">
                                                        ${i.getProduct().getProductName()}
                                                        <br>by ${i.getProduct().getUnit()}
                                                    </div>
                                                    <div class="price">
                                            ...
                                            <td class="product-count">
                                                <a href="DispatchServlet?btAction=Sub&id=${i.getProduct().getProductId()}" class="btn btn-success">-</a>
                                                    ${i.getQuantity()}
                                                <a href="DispatchServlet?btAction=Add&id=${i.getProduct().getProductId()}" class="btn btn-success">+</a>
                                            </td>
                                            <td>
                                                <div class="total">
                                            ...
                                            <td><input type="checkbox" name="select" value="${i.getProduct().getProductId()}"></td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
